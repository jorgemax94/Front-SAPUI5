sap.ui.define([
    ...
    return BaseObject.extend("com.gerdau.logistics.autoatendimento.controller.ListSelector", {
         ...
         * @class
         * @public
         * @alias com.gerdau.logistics.autoatendimento.controller.ListSelector
         */
        ...
        _publishSelectedItem: function() {
            var oEvent = sap.ui.getCore().getEventBus();
            oEvent.publish("ListSelector", "selectedItem");
        },
         ...
         * @return {com.gerdau.logistics.autoatendimento.controller.ListSelector} the list selector object for method chaining
         * @public
         */
